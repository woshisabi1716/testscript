...
local Window = OrionLib:MakeWindow({Name = "培根脚本", HidePremium = false, SaveConfig = true,IntroText = "roblox启动", ConfigFolder = "欢迎使用培根脚本"})
...
Tab:AddParagraph("持续更新，如果发现不可用脚本请向作者反馈，圈钱似全家")
...
Tab:AddButton({
	Name = "DX",
	Callback = function()
loadstring(game:HttpGet(('https://raw.githubusercontent.com/DocYogurt/Main/main/Scripts/Rooms%26Doors')))()
end
})        
